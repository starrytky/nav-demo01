...
var deleteUrl = function deleteUrl(url) {
...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var $li = $("<li>\n    <div class=\"title\">".concat(node.logo, "</div>\n    <div class=\"link\">").concat(deleteUrl(node.url), "</div>\n    <div class=\"close\">\n      <svg class=\"icon\">\n        <use xlink:href=\"#icon-close\"></use>\n      </svg>\n    </div>\n  </li>")).insertBefore($addLink);
...
//# sourceMappingURL=main.d5ca6ee7.js.map